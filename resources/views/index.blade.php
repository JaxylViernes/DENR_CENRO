        ...
        <div class="sides">
          ...
          <form action="{{ route('authenticate') }}" method="POST" class="form-1">
            ...
            <div class="login">
              ...
              <input type="text" name="username" id="username" class="form-control" placeholder="Ex: admin"
                required><br>
              <label for="password">Password</label>
              <input type="password" name="myInput" id="myInput" class="form-control" placeholder="Ex: admin123"
                required>
              <input type="checkbox" onclick="myFunction()" style="text-align: left; margin-right: 10px; "><label
                style="font-size: 12px; margin-bottom: 40px;">Show Password</label>
